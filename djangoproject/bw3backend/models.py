...
class client_config(models.Model):
    ...
    # Fields
    setting = CharField(max_length=100)
...
class plugininstance(models.Model):
    ...
    name = CharField(max_length=255)
    created = DateTimeField(auto_now_add=True, editable=False)
    set_active = models.BooleanField(default=1)
    set_callbychild = models.BooleanField(default=1)
    set_calldirect = models.BooleanField(default=1)
...
class orga_location(models.Model):
    ...
    addr_nr = CharField(max_length=4)
    addr_plz = TextField(max_length=100)
...
class orga_vehical(models.Model):
    ...
    numberplate = TextField(max_length=100)

    # Relationship Fields
    fmskennung = models.ForeignKey(data, on_delete=models.CASCADE)
    location = models.ForeignKey(orga_location,on_delete=models.CASCADE)
